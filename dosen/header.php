  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pertemuan Bimbingan">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#1" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-area-chart"></i>
            <span class="nav-link-text">Petemuan Bimbingan</span>
          </a>
          <ul class="sidenav-second-level collapse" id="1">
            <li>
              <a href="pilih_pertemuan.php">Input Pertemuan</a>
            </li>
            <li>
              <a href="pilih_pertemuan2.php">Tabel Pertemuan</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pertemuan Bimbingan">
          ...
          <ul class="sidenav-second-level collapse" id="2">
            ...
            <li>
              <a href="lihat_tabel_jadwal.php">Lihat Jadwal</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Perizinan Sidang">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#3" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Perizinan Sidang</span>
          </a>
          <ul class="sidenav-second-level collapse" id="3">
            <li>
              <a href="pilih_mahasiswa.php">Input Sidang</a>
            </li>
            <li>
              <a href="lihat_tabel_sidang.php">Lihat Daftar</a>
            </li>
          </ul>
        </li>
      </ul>
