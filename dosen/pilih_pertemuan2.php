...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Tables Pertemuan Bimbingan</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Pertemuan</div>
        <div class="card-body">
            ...
            <table class="table table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <?php
                  ...
                  <td>$nama_mhs</td>
                  <td>$judul_ta</td>
                  <td><a href='lihat_tabel_pertemuan.php?nim=$nim'> Proses </a></td>
                  </tr>";
                }
                ?>
              </tbody>
